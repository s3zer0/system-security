"""
Claude API test for CVE to API mapping
"""
import os
import json
...
class ClaudeMapper:
    ...
    def map_cves_to_apis(self, library_name: str, library_version: str,
        ...
        """
        Send prompt to Claude and get CVE to API mapping
        """
...
def test_claude_mapping():
    """Test Claude CVE to API mapping"""
    print("=" * 50)
    print("Testing Claude CVE to API Mapping")
    print("=" * 50)
    ...
    try:
        ...
        output_file = f"output/claude_opus_{library_name}_{library_version}_mapping.json"
...
def batch_test_libraries():
    ...
    print("=" * 50)
    print("Batch Testing Claude CVE to API Mapping")
    print("=" * 50)
    ...
    # Save all results
    output_file = "output/claude_batch_results.json"
...
if __name__ == "__main__":
    ...
    print("\nTo run batch test: python test_claude.py --batch")